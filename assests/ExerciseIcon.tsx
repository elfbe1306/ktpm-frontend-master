...
export function ExerciseIcon({ width, height, fill }: { width: number, height: number, fill: string }) {
    
    return (
        <svg width={width} height={height} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill={fill}>
